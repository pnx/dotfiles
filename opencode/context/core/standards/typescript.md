...
- **OpenCode TypeScript**: `/home/pnx/.config/opencode/context/openagents-repo/standards/opencode-typescript.md` (framework-specific patterns)
- **Code Quality**: `/home/pnx/.config/opencode/context/core/standards/code-quality.md` (general quality standards)
- **Test Coverage**: `/home/pnx/.config/opencode/context/core/standards/test-coverage.md` (testing standards)
