...
| **Context files** | `/home/pnx/.config/opencode/context/` |
...
| **New context** | `/home/pnx/.config/opencode/context/{category}/{name}.md` |
...
```
/home/pnx/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/home/pnx/.config/opencode/context/core/standards/code-quality.md`
- `/home/pnx/.config/opencode/context/ui/web/react-patterns.md`
- `/home/pnx/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /home/pnx/.config/opencode/context/{category}/

# All context
find /home/pnx/.config/opencode/context -name "*.md"
```
